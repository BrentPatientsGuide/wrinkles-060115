...
$qodePortfolioImages = new QodeMetaBox("portfolio_page", "Select Portfolio Images (multiple upload)");
...
$qodePortfolioImagesVideos2 = new QodeMetaBox("portfolio_page", "Select Portfolio Images/Videos (single upload)");
...
$qodeAdditionalSidebarItems = new QodeMetaBox("portfolio_page", "Select Additional Portfolio Sidebar Items");
...
$qodeGeneral = new QodeMetaBox("portfolio_page", "Select General");
...
$qodeHeader = new QodeMetaBox("portfolio_page", "Select Header","vertical_area",array("yes"));
...
$qodeLeftMenuArea = new QodeMetaBox("portfolio_page", "Select Left Menu Area","vertical_area",array("no"));
...
$qodeTitle = new QodeMetaBox("portfolio_page", "Select Title");
...
$qodeContentBottom = new QodeMetaBox("portfolio_page", "Select Content Bottom");
...
$qodeSeo = new QodeMetaBox("portfolio_page", "Select SEO");
