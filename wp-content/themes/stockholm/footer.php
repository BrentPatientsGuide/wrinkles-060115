...
<?php if ($content_bottom_area == "yes") { ?>
    ...
    <div class="content_bottom" <?php if ($content_bottom_background_color != '') {
        echo 'style="background-color:' . $content_bottom_background_color . ';"';
    } ?>>
...
<footer <?php echo $footer_classes; ?>>
    <div class="footer_inner clearfix">
        ...
        if ($display_footer_top) {
            ...
            <div class="footer_top_holder">
                <div class="footer_top<?php if (!$footer_in_grid) {
                        echo " footer_top_full";
                    } ?>">
    ...
    switch ($footer_top_columns) {
        ...
        if (isset($qode_options['footer_text'])) {
            if ($qode_options['footer_text'] == "yes")
