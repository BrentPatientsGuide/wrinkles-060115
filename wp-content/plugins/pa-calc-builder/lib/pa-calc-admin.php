...
class PA_Calculator_Admin
{
	...
	public function quick_link( $links, $file ) {
		...
		if ($file == $this_plugin) {
			...
			$settings_link	= '<a href="'.menu_page_url( 'pa-calc-builder', 0 ).'">'. __( 'Builder', 'pac' ).'</a>';
	...
	public function scripts_styles( $hook ) {
		...
		if ( $hook == 'calculator_page_calculator-log' ) :
			wp_enqueue_script( 'expanding',	plugins_url('lib/js/expanding.js', dirname(__FILE__) ) , array( 'jquery' ), '1.0.0', true );
		endif;
...
//			wp_enqueue_script( 'jquery-masonry');
	...
	public function menu_items() {
		...
		add_menu_page( __('Calculator', 'pac'), __('Calculator', 'pac'), 'manage_options', 'calculator', array( $this, 'pa_calc_main' ), plugins_url( '/img/icon-16.png', __FILE__ ), '88.8');
			...
			<div class="inner-form-options">
				...
				<ul>
					...
					<li>
						...
						<span class="input">
							<textarea name="prosper-text" id="prosper-text" class="large-text" rows="5"><?php echo esc_attr( $prosper_text ); ?></textarea>
						</span>
